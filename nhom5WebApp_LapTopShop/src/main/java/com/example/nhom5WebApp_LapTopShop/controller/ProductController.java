...
// // public ProductController(ProductService productService, UploadService
// uploadService, ImportJSON importJSON) {
// // >>>>>>> c77ea160e82668791433e22fa8c5a4394b5300be
...
// // public String createProductPage(@ModelAttribute("newProduct") Product
// product,
...
// <<<<<<< HEAD
// // String imgProduct = this.uploadService.handleSaveUploadFile(file,
// "product");
...
// public String getProductPage(Model model, @RequestParam("page")
...
// // public String postUpdateProduct(@ModelAttribute("newProduct") Product
// product,
// // @RequestParam("uploadFile") MultipartFile file) {

// <<<<<<< HEAD
// // Product currentProduct =
// this.productService.getProductById(product.getId()).get();
// =======
// // Lưu đường dẫn cũ
// String oldPathFile = currentProduct.getImage();
// // Lấy đường dẫn đầy đủ của file chứa
// String fullOldPathFile = this.uploadService.getFullPathFile(oldPathFile,
// "product");
...
// public String postDeleteProduct(Model model, @ModelAttribute("newProduct")
// Product product) {
