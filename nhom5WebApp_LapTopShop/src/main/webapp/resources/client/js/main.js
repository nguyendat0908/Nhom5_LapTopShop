(function ($) {
    ...
    $('#btnFilter').click(function (event) {
        ...
        // Truyền giá trị lên URL
        const currentUrl = new URL(window.location.href);
        const searchParams = currentUrl.searchParams;

        // Thêm hoặc cập nhật truy vấn lên URL
    ...
    // Thêm sản phẩm vào giỏ hàng sử dụng ajax
    ...
    // Xem chi tiết giỏ hàng sử dụng ajax
    ...
    // Logic kiểm tra xem có thẻ a chưa, nếu có thì chưa đăng nhập
    function isLogin() {
        const navElement = $("#navbarCollapse");
